...
add_custom_packages() {
    ...
    git_clone openwrt-24.10 https://github.com/1980Add/autocore-arm autocore
    clone_dir https://github.com/Openwrt-Passwall/openwrt-passwall-packages shadowsocks-libev shadowsocksr-libev sing-box
...
apply_custom_settings() {
    ...
    curl -fsSL https://raw.githubusercontent.com/0118Add/build-openwrt/master/scripts/release > package/base-files/files/etc/os-release
